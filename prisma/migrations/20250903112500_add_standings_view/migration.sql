...
WHERE g.status = 'final' GROUP BY ts.team_season_id, ts.league_season_id, ts.team_name, ts.team_abbr, ts.division_id, d.abbr, d.name_short, c.conference_id, c.abbr, c.name_short;